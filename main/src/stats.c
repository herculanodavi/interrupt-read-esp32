...
#define ARRAY_SIZE_OFFSET                                                      \
  5 // Increase if print_real_time_stats returns ESP_ERR_INVALID_SIZE
 ...
 *  - ESP_ERR_INVALID_SIZE  Insufficient array size for
 * uxTaskGetSystemState. Trying increasing ARRAY_SIZE_OFFSET
